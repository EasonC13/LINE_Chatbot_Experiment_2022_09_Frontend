<template lang="">
  <div class="container mt-3">
    ...
    <p>
      而在剛剛聊天過程中，您遇到的聊天 AI
      對象，也都是基於此五種個性去設計的，即他的個性可能是外向、內向或冷靜、神經質等十種。並且搭配兩種性別，總共有二十種組合（5x2x2=20）。
    </p>
    <p>
      另外我們也想探討中文與英文生成回應的差異，我們另外加上五個由中文 AI 直接生成中文的聊天機器人來作對照組。
    </p>
    <p>這些 20 + 5 個聊天機器人構成您在這 5 輪聊天的 25 個聊天對象。
    </p>
    <p>
