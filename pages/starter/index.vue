  ...
  <div class="container mt-5">
    <div class="">
      ...
      <ul>
        ...
        <li>
          本實驗預計完成時間為 80
          分鐘不含休息，因為要操作手機聊天，且問卷題目較多，本實驗也準備相應豐厚的報酬（300元）給耐心完成實驗的您，敬請您耐心且確實地完成實驗。我們會使用比較多的問卷題目，是因為要跑一個比較複雜的統計分析來找出適合的聊天機器人設計，非常感謝您耐心提供的寶貴實驗資料。
        </li>
        <li>
